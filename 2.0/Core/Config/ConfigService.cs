...
namespace FS服装搭配专家.Core.Config
{
    public class ConfigService
    {
        ...
        public double VideoOverlayOpacity
        {
            get => _config.UI.VideoOverlayOpacity;
            set
            {
                _config.UI.VideoOverlayOpacity = value;
                SaveConfig();
            }
        }
        ...
        {
            get => _config.UI.Borderless;
            set
            {
                _config.UI.Borderless = value;
                SaveConfig();
            }
        }
